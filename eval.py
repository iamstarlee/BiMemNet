...
def main():
    ...
    model_path = 'weights/first10-large.pth' # 'SNN_logs/latent_12800/latent_12800.pth'
    ...
    # 创建模型
    model = YoloBody((640, 640), num_classes, 's', False)
    ...
    # torch.save(rand_tensor, 'rand_tensor.pth')
    # z = model(rand_tensor)
